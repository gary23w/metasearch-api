...
import (
	...
	"github.com/gary23w/metasearch_api/internal/autocomplete"
...
func NewEngine(ctx context.Context, provs ...models.Provider) (*Engine, error) {
	s := &Engine{
		provs: provs,
		byID:  make(map[string]models.Provider),
	}
	if len(s.provs) == 0 {
		s.provs = nil
...
type Engine struct {
	...
	byID  map[string]models.Provider
